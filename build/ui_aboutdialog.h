...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Dic", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Dic</b> version", 0));
...
"Copyright \302\251 2016 The Dic developers", 0));
