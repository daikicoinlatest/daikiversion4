...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 ATOM"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 ATOM"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 ATOM"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 ATOM"));
