...
int64_t GetProofOfWorkReward(int64_t nFees)
{
        ...
        if(nBestHeight == 50)
         ...
         if(nBestHeight > 101)
         {
          ...
          if(nBestHeight == 2070)
         {
             int64_t nSubsidy1 =10000000;
             int64_t nSubsidy3 =18 * nSubsidy1;			 
             nSubsidy =  nSubsidy3 * COIN  ;
         }
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The times 18.4.2018. diccoi project is here.";
        CTransaction txNew;
        txNew.nTime = 1524067020;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1524067020;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1524585132 : 1524585132;

        assert(block.hashMerkleRoot == uint256("0x98a770138a1a38a709fc6f2d9ad2156fa253722bf13b2b4ec21fce189e962ab0"));
