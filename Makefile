...
# Project:  Dic-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake RELEASE=1 USE_UPNP=1 USE_DBUS=1 -o Makefile Dic-qt.pro
#############################################################################
...
DISTDIR = /root/daikiversion4/build/dic-qt1.0.7
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -Wl,-Bstatic -lminiupnpc /root/daikiversion4/src/leveldb/libleveldb.a /root/daikiversion4/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lQt5PrintSupport -lQt5Widgets -lQt5Gui -lQt5Network -lQt5DBus -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: Dic-qt.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) RELEASE=1 USE_UPNP=1 USE_DBUS=1 -o Makefile Dic-qt.pro
...
clean: compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /root/daikiversion4/src/leveldb/libleveldb.a; cd /root/daikiversion4/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/root/daikiversion4/src/leveldb/libleveldb.a: FORCE
	cd /root/daikiversion4/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/root/daikiversion4/build/build.h: FORCE
	cd /root/daikiversion4; /bin/sh share/genbuild.sh /root/daikiversion4/build/build.h
...
build/moc_bitcoingui.cpp: src/qt/bitcoingui.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I/root/daikiversion4 -I/root/daikiversion4/src -I/root/daikiversion4/src/json -I/root/daikiversion4/src/qt -I/root/daikiversion4/src/leveldb/include -I/root/daikiversion4/src/leveldb/helpers -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtPrintSupport -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtNetwork -I/usr/include/x86_64-linux-gnu/qt5/QtDBus -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/5 -I/usr/include/x86_64-linux-gnu/c++/5 -I/usr/include/c++/5/backward -I/usr/lib/gcc/x86_64-linux-gnu/5/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/5/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include src/qt/bitcoingui.h -o build/moc_bitcoingui.cpp
