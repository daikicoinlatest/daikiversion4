...
# Project:  Dic-qt.pro
# Template: app
# Command: C:\Qt\5.3.2\bin\qmake.exe USE_UPNP=- -o Makefile Dic-qt.pro
#############################################################################
...
Makefile: Dic-qt.pro ../Qt/5.3.2/mkspecs/win32-g++/qmake.conf ../Qt/5.3.2/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile Dic-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:\ATX-dic-source-master\src\leveldb\libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:\ATX-dic-source-master\src\leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) clean
distclean: release-distclean debug-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) C:\ATX-dic-source-master\dic-qt_plugin_import.cpp

C:/ATX-dic-source-master/src/leveldb/libleveldb.a: FORCE
